    ...
    <header className='header'>
        <div className='header-left-side'>
            <div className='header-content'>
                <span>Sale 70%</span>
                <h1>Fashion that speaks for itself.</h1>
                <p>Discover the latest in fashion and elevate your style with our range of high-quality and trendy clothing. From classic staples to on-trend pieces, we have everything you need to redefine your wardrobe.</p>
                <Link href='/products'>
                     <button className='btn' type='button'><CgShoppingCart size={26} />Discover</button>
                </Link>
            </div>
